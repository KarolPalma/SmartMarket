...
?>
    ...
    <head>
        ...
        <title>Filtro de Empleados - Smart Market</title>
        <!--Scripts-->
    ...
    <body>
        ...
        <div class="container">
            <div class="col-12 text-center mt-5 mb-5">
                <h3 style="background-color: #6AB759; color: white;">Filtrar Empleados</h3>
            </div>
        ...
        <div class="d-flex justify-content-center my-4">
            ...
            <table id='tabla' class="table table-striped table-bordered" style="max-width: 1100px;">
                ...
                if ($accion == "consultar") {
                    $sql = "SELECT * FROM Empleados WHERE Id_Empleado = '$identidad'";
                    ...
                    if (mysqli_num_rows($result) != 0) { //Si la respuesta contiene por lo menos un registro, imprime la tabla
                        ...
                        <td style='text-align: center'><a class='btn btn-primary' style='background-color: #6AB759; border-color: #6AB759;' href='form_actualizarEmpleado.php?idEmpleado=" . $row["Id_Empleado"] . "'> Actualizar Empleado</a></td>
