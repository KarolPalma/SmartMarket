...
?>
    ...
    <head>
        ...
        <title>Filtro de Clientes - Smart Market</title>
        <!--Scripts-->
    ...
    <body>
        ...
        <div class="container">
            <div class="col-12 text-center mt-5 mb-5">
                <h3 style="background-color: #6AB759; color: white;">Filtrar Clientes</h3>
            </div>
            ...
            <table id='tabla' class="table table-striped table-bordered" style="max-width: 1100px;">
                ...
                if ($accion == "consultar") {
                    ...
                    if (mysqli_num_rows($result) != 0) { //Si la respuesta contiene por lo menos un registro, imprime la tabla
                        ...
                        <td style='text-align: center'><a class='btn btn-primary' style='background-color: #6AB759; border-color: #6AB759;' href='form_actualizarCliente.php?idCliente=" . $row["Id_Cliente"] . "'> Actualizar Cliente</a></td>
                    ...
                    $sql = "SELECT * FROM Clientes WHERE Id_Cliente <> 0";
                    $result = mysqli_query($conexion, $sql);
                    if (mysqli_num_rows($result) != 0) { //Si la respuesta contiene por lo menos un registro, imprime la tabla
                        echo
                        "<thead>
